...
void list_append(struct list_t ** pp_head, void * p_item)
{
    if (NULL == *pp_head) {
        *pp_head = p_item;
    } else {
...
void list_append_front(struct list_t ** pp_head, void * p_item)
{
...
void * list_remove_front(struct list_t ** pp_head)
{
...
void * list_get(struct list_t * p_head, size_t index)
{
...
size_t list_cnt(struct list_t * p_head)
{
...
void * list_find(struct list_t * p_head, void * p_item_crit, list_item_cmp cmp)
{
    while (NULL != p_head) {
...
void * list_remove(struct list_t ** pp_head, void * p_item, list_item_cmp cmp)
{
