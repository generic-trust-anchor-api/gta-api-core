...
struct {
    ...
    handle_map_entry_t map[GTA_HANDLE_MAP_SIZE + 1 /* index 0 is reserved */];
...
static gta_handle_t alloc_handle(gta_handle_type_t type, void * params, void ** p_ptr, gta_errinfo_t * p_errinfo);

static bool free_handle(gta_handle_t h, gta_errinfo_t * p_errinfo);
...
static object_t * create_framework_enum_object(instance_object_t * p_inst_obj, gta_errinfo_t * p_errinfo);

static bool
destroy_framework_enum_object(struct framework_enum_object_t * p_framework_enum_obj, gta_errinfo_t * p_errinfo);
...
static object_t * create_instance_object(const struct gta_instance_params_t * p_params, gta_errinfo_t * p_errinfo);

static bool destroy_instance_object(instance_object_t * p_ctx_obj, gta_errinfo_t * p_errinfo);

/* Validate the given handle and return pointer to the managed object. */
static instance_object_t * check_instance_handle(gta_instance_handle_t h_ctx, gta_errinfo_t * p_errinfo);
...
static object_t * create_context_object(instance_object_t * p_inst_obj, gta_errinfo_t * p_errinfo);

static bool destroy_context_object(context_object_t * p_ctx_obj, gta_errinfo_t * p_errinfo);

/* Validate the given handle and return pointer to the managed object. */
static context_object_t * check_context_handle(gta_context_handle_t h_ctx, gta_errinfo_t * p_errinfo);
...
/* Validate the given handle and return pointer to the managed object. */
// FIXME this prototype causes an compile error with GCC. The error states that a incompatible redefinition was done. It
// is not clear why this fails
// static void *
...
static object_t * create_access_policy_object(instance_object_t * p_inst_obj, gta_errinfo_t * p_errinfo);
...
static object_t * create_access_token_descriptor_object(
    struct access_policy_object_t * p_access_policy_object,
    gta_errinfo_t * p_errinfo);

static bool destroy_access_token_descriptor_object(
    struct access_token_descriptor_object_list_item_t * p_token_descriptor_object,
    gta_errinfo_t * p_errinfo);

static struct access_token_descriptor_object_list_item_t * check_access_token_descriptor_handle(
...
#define basic_pointer_validation(p_errinfo, ...)                                                                       \
    basic_pointer_validation_internal(                                                                                 \
        p_errinfo,                                                                                                     \
...
static bool provider_uid_cmp(void * p_provider_list_item, void * p_uid);

static bool profile_name_cmp(void * p_profile_list_item, void * p_profile_name);
...
GTA_DEFINE_FUNCTION(
    bool,
    gta_register_provider,
    (gta_instance_handle_t h_inst, const struct gta_provider_info_t * p_provider_info, gta_errinfo_t * p_errinfo))
{
    bool b_ret = false;
    instance_object_t * p_inst_obj;
...
#pragma GCC diagnostic ignored "-Wpedantic"
            ...
            p_provider_list_item = list_find(
                (struct list_t *)(p_inst_obj->p_provider_list),
                (void *)(p_provider_info->provider_init),
                provider_uid_cmp);
            ...
            if (NULL == p_provider_list_item) {
                ...
                if (NULL != p_provider_list_item) {
                    p_provider_list_item->h_ctx =
                        alloc_handle(GTA_HANDLE_TYPE_CONTEXT, p_inst_obj, (void **)(&p_ctx_obj), p_errinfo);
...
#pragma GCC diagnostic pop
            ...
            p_profile_list_item = list_find(
                ...
                p_provider_info->profile_info.profile_name,
                profile_name_cmp);
                ...
                if (NULL != p_profile_list_item) {
                    ...
                    if ((0 != profile_name_length) && (PROFILE_NAME_LENGTH_MAX != profile_name_length)) {
                        p_profile_list_item->profile_name =
                            p_inst_obj->params.os_functions.calloc(1, profile_name_length + 1);
                        if (NULL != p_profile_list_item->profile_name) {
                            memcpy(
                                p_profile_list_item->profile_name,
                                p_provider_info->profile_info.profile_name,
                                profile_name_length + 1);
...
check_instance_provider_handle(gta_instance_handle_t h_inst, gta_errinfo_t * p_errinfo);

static object_t * create_instance_provider_object(instance_object_t * p_inst_obj, gta_errinfo_t * p_errinfo);

static bool destroy_instance_provider_object(
    struct instance_provider_object_t * p_instance_provider_obj,
    gta_errinfo_t * p_errinfo);

GTA_DEFINE_FUNCTION(void *, gta_provider_get_params, (gta_instance_handle_t h_inst, gta_errinfo_t * p_errinfo))
{
...
GTA_DEFINE_FUNCTION(
    gta_instance_handle_t,
    gta_instance_init,
    (const struct gta_instance_params_t * p_instance_params, gta_errinfo_t * p_errinfo))
{
    ...
    if (NULL != instance_params.global_mutex) {
        ...
        if ((NULL == instance_params.os_functions.mutex_create) ||
            (NULL == instance_params.os_functions.mutex_destroy) || (NULL == instance_params.os_functions.mutex_lock) ||
    ...
    if (instance_params.os_functions.mutex_lock(instance_params.global_mutex)) {
        ...
        if ((NULL == instance_params.os_functions._calloc_dbg) || (NULL == instance_params.os_functions._free_dbg))
#else
    if ((NULL == instance_params.os_functions.calloc) || (NULL == instance_params.os_functions.free))
#endif
        {
            *p_errinfo = GTA_ERROR_INVALID_PARAMETER;
            goto err;
        ...
        h_inst = alloc_handle(GTA_HANDLE_TYPE_INSTANCE, &instance_params, (void **)(&p_inst_obj), p_errinfo);
        if (!h_inst)
            goto err;
        ...
        p_inst_obj->h_access_policy_simple_initial = alloc_handle(
            ...
            p_inst_obj,
            (void **)(&p_access_policy_obj_simple_initial),
            p_errinfo);
        if (!p_inst_obj->h_access_policy_simple_initial)
            goto err;

        h_token_descriptor = alloc_handle(
            GTA_HANDLE_TYPE_ACCESS_TOKEN_DESCRIPTOR,
            p_access_policy_obj_simple_initial,
            (void **)(&(p_access_policy_obj_simple_initial->p_initial_access_token_descriptor)),
            p_errinfo);
        if (GTA_HANDLE_INVALID == h_token_descriptor)
            goto err;
        p_access_policy_obj_simple_initial->p_initial_access_token_descriptor->type =
            GTA_ACCESS_DESCRIPTOR_TYPE_INITIAL;
        p_access_policy_obj_simple_initial->p_initial_access_token_descriptor->h_self = h_token_descriptor;

        list_append_front(
            (struct list_t **)(&(p_access_policy_obj_simple_initial->p_access_token_descriptor_list)),
            p_access_policy_obj_simple_initial->p_initial_access_token_descriptor);

        /* basic */
        p_inst_obj->h_access_policy_simple_basic = alloc_handle(
            GTA_HANDLE_TYPE_ACCESS_POLICY_SIMPLE, p_inst_obj, (void **)(&p_access_policy_obj_simple_basic), p_errinfo);
        if (!p_inst_obj->h_access_policy_simple_basic)
            goto err;

        h_token_descriptor = alloc_handle(
            GTA_HANDLE_TYPE_ACCESS_TOKEN_DESCRIPTOR,
            p_access_policy_obj_simple_basic,
            (void **)(&(p_access_policy_obj_simple_basic->p_basic_access_token_descriptor)),
            p_errinfo);
        if (GTA_HANDLE_INVALID == h_token_descriptor)
            goto err;
        p_access_policy_obj_simple_basic->p_basic_access_token_descriptor->type =
            GTA_ACCESS_DESCRIPTOR_TYPE_BASIC_TOKEN;
        p_access_policy_obj_simple_basic->p_basic_access_token_descriptor->h_self = h_token_descriptor;

        list_append_front(
            (struct list_t **)(&(p_access_policy_obj_simple_basic->p_access_token_descriptor_list)),
        ...
        p_inst_obj->h_access_policy_simple_physical_presence = alloc_handle(
            GTA_HANDLE_TYPE_ACCESS_POLICY_SIMPLE,
            p_inst_obj,
            (void **)(&p_access_policy_obj_simple_physical_presence),
            p_errinfo);
        if (!p_inst_obj->h_access_policy_simple_physical_presence)
            goto err;

        h_token_descriptor = alloc_handle(
            GTA_HANDLE_TYPE_ACCESS_TOKEN_DESCRIPTOR,
            p_access_policy_obj_simple_physical_presence,
            (void **)&p_physical_presence_access_token_descriptor,
            p_errinfo);
        if (GTA_HANDLE_INVALID == h_token_descriptor)
            goto err;
        p_physical_presence_access_token_descriptor->type = GTA_ACCESS_DESCRIPTOR_TYPE_PHYSICAL_PRESENCE_TOKEN;
        p_physical_presence_access_token_descriptor->h_self = h_token_descriptor;

        list_append_front(
            (struct list_t **)(&(p_access_policy_obj_simple_physical_presence->p_access_token_descriptor_list)),
...
GTA_DEFINE_FUNCTION(bool, gta_instance_final, (gta_instance_handle_t h_inst, gta_errinfo_t * p_errinfo))
{
    instance_object_t * p_inst_obj = NULL_PTR;
    struct provider_list_item_t * p_provider_list_item;
    ...
    if (NULL != p_inst_obj) {
        ...
        while (NULL != p_provider_list_item) {
            p_provider_list_item->pf_free_params(p_provider_list_item->p_provider_params);
            free_handle(p_provider_list_item->h_ctx, p_errinfo);
        ...
        while (NULL != p_profile_list_item) {
            p_inst_obj->params.os_functions.free(p_profile_list_item->profile_name);
        ...
        if ((NULL != personality_name) && (NULL != profile)) {
            ...
            if (find_personality(h_inst, personality_name, &p_provider_list_item, p_errinfo)) {
                if (NULL != p_provider_list_item) {
                     ...
                     * provider */
                    p_profile_list_item =
                        list_find((struct list_t *)(p_inst_obj->p_profile_list), profile, profile_name_cmp);
                    if ((NULL != p_profile_list_item) && (p_provider_list_item == p_profile_list_item->p_provider)) {
                        h_prectx = alloc_handle(GTA_HANDLE_TYPE_CONTEXT, p_inst_obj, (void **)(&p_ctx_obj), p_errinfo);
                        p_ctx_obj->p_provider = p_provider_list_item;
                        if (NULL != p_provider_list_item->function_list->pf_gta_provider_context_open) {
                            if (p_provider_list_item->function_list->pf_gta_provider_context_open(
                                    h_prectx, personality_name, profile, &(p_ctx_obj->p_context_params), p_errinfo)) {
                                h_ctx = h_prectx;
                            } else {
...
GTA_DEFINE_FUNCTION(bool, gta_context_close, (gta_context_handle_t h_ctx, gta_errinfo_t * p_errinfo))
{
...
GTA_DEFINE_FUNCTION(
    bool,
    gta_access_token_get_pers_derived,
    (gta_context_handle_t h_ctx,
     ...
     gta_errinfo_t * p_errinfo))
{
    ...
    if (NULL != p_ctx_obj) {
        return GTA_PROVIDER_FWD_FUNCTION(
            ...
            gta_access_token_get_pers_derived,
            (h_ctx, target_personality_name, usage, p_pers_derived_access_token, p_errinfo));
    }
    *p_errinfo = GTA_ERROR_HANDLE_INVALID;
    return false;
}
...
GTA_DEFINE_FUNCTION(
    bool,
    gta_context_auth_set_access_token,
    (gta_context_handle_t h_ctx, const gta_access_token_t access_token, gta_errinfo_t * p_errinfo))
{
    ...
    if (NULL != p_ctx_obj) {
        return GTA_PROVIDER_FWD_FUNCTION(
            p_ctx_obj->p_provider, gta_context_auth_set_access_token, (h_ctx, access_token, p_errinfo));
    }
    *p_errinfo = GTA_ERROR_HANDLE_INVALID;
    return false;
}
...
GTA_DEFINE_FUNCTION(
    bool,
    gta_context_auth_get_challenge,
    (gta_context_handle_t h_ctx, gtaio_ostream_t * challenge, gta_errinfo_t * p_errinfo))
{
    ...
    if (NULL != p_ctx_obj) {
        return GTA_PROVIDER_FWD_FUNCTION(
            p_ctx_obj->p_provider, gta_context_auth_get_challenge, (h_ctx, challenge, p_errinfo));
    }
    *p_errinfo = GTA_ERROR_HANDLE_INVALID;
    return false;
}
    ...
    (gta_context_handle_t h_ctx, gtaio_istream_t * random, gta_errinfo_t * p_errinfo))
{
    ...
    if (NULL != p_ctx_obj) {
        return GTA_PROVIDER_FWD_FUNCTION(
            p_ctx_obj->p_provider, gta_context_auth_set_random, (h_ctx, random, p_errinfo));
    }
    *p_errinfo = GTA_ERROR_HANDLE_INVALID;
    return false;
}
     ...
     gta_errinfo_t * p_errinfo))
{
    ...
    if (NULL != p_ctx_obj) {
        return GTA_PROVIDER_FWD_FUNCTION(
            p_ctx_obj->p_provider, gta_context_get_attribute, (h_ctx, attrtype, p_attrvalue, p_errinfo));
    }
    *p_errinfo = GTA_ERROR_HANDLE_INVALID;
    return false;
}
     ...
     gta_errinfo_t * p_errinfo))
{
    ...
    if (NULL != p_ctx_obj) {
         ...
         * provider? */
        return GTA_PROVIDER_FWD_FUNCTION(
            p_ctx_obj->p_provider, gta_context_set_attribute, (h_ctx, attrtype, p_attrvalue, p_errinfo));
    }
    *p_errinfo = GTA_ERROR_HANDLE_INVALID;
    return false;
}
     ...
     gta_errinfo_t * p_errinfo))
{
    ...
    if (NULL != p_inst_obj) {
        ...
        if (NULL != check_access_policy_handle(h_auth_recede, true, p_errinfo)) {
            /* wrap h_inst */
            p_provider_list_item = p_inst_obj->p_provider_list;
            h_inst_provider = alloc_handle(
                GTA_HANDLE_TYPE_INSTANCE_PROVIDER, p_inst_obj, (void **)(&p_instance_provider_obj), p_errinfo);
            if (GTA_HANDLE_INVALID != h_inst_provider) {
                p_instance_provider_obj->h_inst = h_inst;
                p_instance_provider_obj->p_provider = p_provider_list_item;
...
GTA_DEFINE_FUNCTION(void *, gta_context_get_params, (gta_context_handle_t h_ctx, gta_errinfo_t * p_errinfo))
{
    const context_object_t * p_ctx_obj = NULL_PTR;
...
GTA_DEFINE_FUNCTION(
    ...
    (gta_instance_handle_t h_inst, gta_errinfo_t * p_errinfo))
{
    instance_object_t * p_inst_obj = NULL;
    gta_access_policy_handle_t h_access_policy = GTA_HANDLE_INVALID;
    ...
    if ((p_inst_obj = check_instance_handle(h_inst, p_errinfo))) {
        h_access_policy =
            alloc_handle(GTA_HANDLE_TYPE_ACCESS_POLICY, p_inst_obj, (void **)(&p_access_policy_obj), p_errinfo);
    }
...
GTA_DEFINE_FUNCTION(
    ...
    (gta_access_policy_handle_t h_access_policy, gta_errinfo_t * p_errinfo))
{
    if (true != basic_pointer_validation(p_errinfo)) {
        return false;
    }
    ...
    (gta_access_policy_handle_t h_access_policy, gta_errinfo_t * p_errinfo))
{
    ...
    p_access_policy_obj =
        (/* const_cast */ struct access_policy_object_t *)check_access_policy_handle(h_access_policy, false, p_errinfo);
    if (p_access_policy_obj) {
        ...
        if (p_access_policy_obj->p_physical_presence_access_token_descriptor == NULL) {
            ...
            h_token_descriptor = alloc_handle(
                GTA_HANDLE_TYPE_ACCESS_TOKEN_DESCRIPTOR,
                p_access_policy_obj,
                (void **)(&p_token_descriptor_object),
                p_errinfo);
            if (GTA_HANDLE_INVALID == h_token_descriptor)
                goto err;
            ...
            list_append_front(
                (struct list_t **)(&(p_access_policy_obj->p_access_token_descriptor_list)), p_token_descriptor_object);
        }
    } else {
        return false;
    }
...
err:
    if (verification_profile_name_copy) {
        p_access_policy_obj->p_inst_obj->params.os_functions.free(verification_profile_name_copy);
    }
...
GTA_DEFINE_FUNCTION(
    void *,
    gta_secmem_calloc,
    (gta_context_handle_t h_ctx, size_t n, size_t size, gta_errinfo_t * p_errinfo))
{
    ...
    if ((p_ctx_obj = check_context_handle(h_ctx, p_errinfo))) {
        ...
        p_secmem = p_calloc(1, sizeof(struct secmem_block_t), _NORMAL_BLOCK, __FILE__, __LINE__);
#else
...
static bool secmem_block_cmp(void * p_block1, void * p_block2);

GTA_DEFINE_FUNCTION(bool, gta_secmem_free, (gta_context_handle_t h_ctx, void * ptr, gta_errinfo_t * p_errinfo))
{
    bool b_ret = false;
    context_object_t * p_ctx_obj = NULL;
    ...
    if ((p_ctx_obj = check_context_handle(h_ctx, p_errinfo))) {
        block.ptr = ptr;
        p_secmem_block =
            list_remove((struct list_t **)&(p_ctx_obj->p_secmem_first), &block, (list_item_cmp)secmem_block_cmp);
        if (p_secmem_block) {
            gta_memset(
                p_secmem_block->ptr,
                p_secmem_block->n * p_secmem_block->size,
                0,
                p_secmem_block->n * p_secmem_block->size);
            p_ctx_obj->p_inst_obj->params.os_functions.free(p_secmem_block->ptr);
            gta_memset(p_secmem_block, sizeof(struct secmem_block_t), 0, sizeof(struct secmem_block_t));
...
GTA_DEFINE_FUNCTION(
    void *,
    gta_secmem_checkptr,
    (gta_context_handle_t h_ctx, void * p_check, gta_errinfo_t * p_errinfo))
{
    ...
    p_ctx_obj = check_context_handle(h_ctx, p_errinfo);
    if (p_ctx_obj) {
        if (list_find((struct list_t *)(p_ctx_obj->p_secmem_first), &block, (list_item_cmp)secmem_block_cmp)) {
            return p_check;
        }
    }
...
GTA_DEFINE_FUNCTION(gta_mutex_t, gta_mutex_create, (gta_context_handle_t h_ctx))
{
...
GTA_DEFINE_FUNCTION(bool, gta_mutex_destroy, (gta_context_handle_t h_ctx, gta_mutex_t mutex))
{
    gta_errinfo_t errinfo; /* @todo: Pass through parameter list? */
    const context_object_t * p_ctx_obj = NULL;
...
GTA_DEFINE_FUNCTION(bool, gta_mutex_lock, (gta_context_handle_t h_ctx, gta_mutex_t mutex))
{
    gta_errinfo_t errinfo; /* @todo: Pass through parameter list? */
    const context_object_t * p_ctx_obj = NULL;
...
GTA_DEFINE_FUNCTION(bool, gta_mutex_unlock, (gta_context_handle_t h_ctx, gta_mutex_t mutex))
{
    gta_errinfo_t errinfo; /* @todo: Pass through parameter list? */
    const context_object_t * p_ctx_obj = NULL;
...
static size_t ocmpstream_write(ocmpstream_t * ostream, const char * data, size_t len, gta_errinfo_t * p_errinfo)
{
...
static size_t ostream_null_write(gtaio_ostream_t * ostream, const char * data, size_t len, gta_errinfo_t * p_errinfo)
{
    return len;
}

static bool ostream_finish(gtaio_stream_finish_t * ostream, gta_errinfo_t errinfo, gta_errinfo_t * p_errinfo)
{
    return true;
}
    ...
    if (NULL != p_inst_obj) {
        ...
        if (GTA_HANDLE_INVALID != h_inst_provider) {
            ...
            while (b_loop) {
                ...
                if (gta_identifier_enumerate(h_inst, &h_enum, &o_idtype, (gtaio_ostream_t *)&o_idvalue, &errinfo)) {
                        ...
                        if (b_name_clash) {
                            *p_errinfo = GTA_ERROR_NAME_ALREADY_EXISTS;
                            ...
                            b_ret = GTA_PROVIDER_FWD_FUNCTION(
                                p_provider_list_item,
                                gta_identifier_assign,
                                (h_inst_provider, identifier_type, identifier_value, p_errinfo));
                        }
                    }
                }
            }
...
static struct framework_enum_object_t *
get_framework_enum_obj(instance_object_t * p_inst_obj, gta_enum_handle_t * ph_enum)
{
    ...
    if (GTA_HANDLE_ENUM_FIRST == *ph_enum) {
        *ph_enum = alloc_handle(GTA_HANDLE_TYPE_FRAMEWORK_ENUM, p_inst_obj, (void **)(&p_framework_enum_obj), &errinfo);
        ...
        p_framework_enum_obj = check_framework_enum_handle(*ph_enum, &errinfo);
    }
     ...
     gta_errinfo_t * p_errinfo))
{
    ...
    if ((GTA_PERSONALITY_ENUM_ALL != flags) && (GTA_PERSONALITY_ENUM_ACTIVE != flags) &&
    ...
    if ((NULL == p_framework_enum_obj) || (p_inst_obj != p_framework_enum_obj->p_inst_obj)) {
    ...
    while (b_loop) {
        ...
        b_ret = GTA_PROVIDER_FWD_FUNCTION(
            p_framework_enum_obj->p_provider,
            gta_personality_enumerate,
            (h_inst_provider, identifier_value, &(p_framework_enum_obj->h_enum), flags, personality_name, &errinfo));
...
GTA_DEFINE_FUNCTION(
    bool,
    gta_personality_enumerate_application,
    (gta_instance_handle_t h_inst,
     ...
     gta_errinfo_t * p_errinfo))
{
    ...
    while (b_loop) {
        ...
        b_ret = GTA_PROVIDER_FWD_FUNCTION(
            p_framework_enum_obj->p_provider,
            gta_personality_enumerate_application,
            (h_inst_provider, application_name, &(p_framework_enum_obj->h_enum), flags, personality_name, &errinfo));
     ...
     gta_errinfo_t * p_errinfo))
{
    ...
    while (b_loop) {
        ...
        b_ret = GTA_PROVIDER_FWD_FUNCTION(
            p_framework_enum_obj->p_provider,
            gta_identifier_enumerate,
            (h_inst_provider, &(p_framework_enum_obj->h_enum), identifier_type, identifier_value, &errinfo));
...
select_provider_by_profile(gta_instance_handle_t h_inst, const gta_profile_name_t profile, gta_errinfo_t * p_errinfo)
{
    instance_object_t * p_inst_obj;
    struct provider_list_item_t * p_provider_list_item = NULL_PTR;
    ...
    if (NULL != p_inst_obj) {
        p_profile_list_item = list_find((struct list_t *)(p_inst_obj->p_profile_list), profile, profile_name_cmp);
        if (NULL != p_profile_list_item) {
     ...
     gta_errinfo_t * p_errinfo))
{
    ...
    if (true == basic_pointer_validation(
                    p_errinfo, identifier_value, personality_name, application, profile, personality_content)) {
        b_ret = personality_deploy_create(
            h_inst,
            identifier_value,
            personality_name,
            application,
    ...
    (gta_context_handle_t h_ctx, gtaio_ostream_t * p_personality_enrollment_info, gta_errinfo_t * p_errinfo))
{
    ...
    if (NULL != p_ctx_obj) {
        return GTA_PROVIDER_FWD_FUNCTION(
            p_ctx_obj->p_provider, gta_personality_enroll, (h_ctx, p_personality_enrollment_info, p_errinfo));
    }
    *p_errinfo = GTA_ERROR_HANDLE_INVALID;
    return false;
}
...
GTA_DEFINE_FUNCTION(bool, gta_personality_remove, (gta_context_handle_t h_ctx, gta_errinfo_t * p_errinfo))
{
    ...
    p_ctx_obj = check_context_handle(h_ctx, p_errinfo);
    if (NULL != p_ctx_obj) {
        return GTA_PROVIDER_FWD_FUNCTION(p_ctx_obj->p_provider, gta_personality_remove, (h_ctx, p_errinfo));
    }
    *p_errinfo = GTA_ERROR_HANDLE_INVALID;
    return false;
}

GTA_DEFINE_FUNCTION(bool, gta_personality_deactivate, (gta_context_handle_t h_ctx, gta_errinfo_t * p_errinfo))
{
    const context_object_t * p_ctx_obj = NULL_PTR;
    ...
    p_ctx_obj = check_context_handle(h_ctx, p_errinfo);
    if (NULL != p_ctx_obj) {
        return GTA_PROVIDER_FWD_FUNCTION(p_ctx_obj->p_provider, gta_personality_deactivate, (h_ctx, p_errinfo));
    }
    *p_errinfo = GTA_ERROR_HANDLE_INVALID;
    return false;
}

GTA_DEFINE_FUNCTION(bool, gta_personality_activate, (gta_context_handle_t h_ctx, gta_errinfo_t * p_errinfo))
{
    const context_object_t * p_ctx_obj = NULL_PTR;
    ...
    p_ctx_obj = check_context_handle(h_ctx, p_errinfo);
    if (NULL != p_ctx_obj) {
        return GTA_PROVIDER_FWD_FUNCTION(p_ctx_obj->p_provider, gta_personality_activate, (h_ctx, p_errinfo));
    }
    *p_errinfo = GTA_ERROR_HANDLE_INVALID;
    return false;
}
...
GTA_DEFINE_FUNCTION(
    bool,
    gta_personality_add_trusted_attribute,
    (gta_context_handle_t h_ctx,
     ...
     gta_errinfo_t * p_errinfo))
{
    ...
    if (NULL != p_ctx_obj) {
        return GTA_PROVIDER_FWD_FUNCTION(
            p_ctx_obj->p_provider,
            gta_personality_add_trusted_attribute,
            (h_ctx, attrtype, attrname, p_attrvalue, p_errinfo));
    }
    *p_errinfo = GTA_ERROR_HANDLE_INVALID;
    return false;
}
     ...
     gta_errinfo_t * p_errinfo))
{
    ...
    if (NULL != p_ctx_obj) {
        return GTA_PROVIDER_FWD_FUNCTION(
            p_ctx_obj->p_provider, gta_personality_add_attribute, (h_ctx, attrtype, attrname, p_attrvalue, p_errinfo));
    }
    *p_errinfo = GTA_ERROR_HANDLE_INVALID;
    return false;
}
     ...
     gta_errinfo_t * p_errinfo))
{
    ...
    if (NULL != p_ctx_obj) {
        return GTA_PROVIDER_FWD_FUNCTION(
            p_ctx_obj->p_provider, gta_personality_get_attribute, (h_ctx, attrname, p_attrvalue, p_errinfo));
    }
    *p_errinfo = GTA_ERROR_HANDLE_INVALID;
    return false;
}
    ...
    (gta_context_handle_t h_ctx, const gta_personality_attribute_name_t attrname, gta_errinfo_t * p_errinfo))
{
    ...
    if (NULL != p_ctx_obj) {
        return GTA_PROVIDER_FWD_FUNCTION(
            p_ctx_obj->p_provider, gta_personality_remove_attribute, (h_ctx, attrname, p_errinfo));
    }
    *p_errinfo = GTA_ERROR_HANDLE_INVALID;
    return false;
}
...
GTA_DEFINE_FUNCTION(
    bool,
    gta_personality_deactivate_attribute,
    (gta_context_handle_t h_ctx, const gta_personality_attribute_name_t attrname, gta_errinfo_t * p_errinfo))
{
    const context_object_t * p_ctx_obj = NULL_PTR;
    ...
    if (NULL != p_ctx_obj) {
        return GTA_PROVIDER_FWD_FUNCTION(
            p_ctx_obj->p_provider, gta_personality_deactivate_attribute, (h_ctx, attrname, p_errinfo));
    }
    *p_errinfo = GTA_ERROR_HANDLE_INVALID;
    return false;
}
...
GTA_DEFINE_FUNCTION(
    bool,
    gta_personality_activate_attribute,
    (gta_context_handle_t h_ctx, gta_personality_attribute_name_t attrname, gta_errinfo_t * p_errinfo))
{
    ...
    if (NULL != p_ctx_obj) {
        return GTA_PROVIDER_FWD_FUNCTION(
            p_ctx_obj->p_provider, gta_personality_activate_attribute, (h_ctx, attrname, p_errinfo));
    }
    *p_errinfo = GTA_ERROR_HANDLE_INVALID;
    return false;
}
    ...
    (gta_context_handle_t h_ctx, gtaio_istream_t * data, gtaio_ostream_t * protected_data, gta_errinfo_t * p_errinfo))
{
    ...
    if (NULL != p_ctx_obj) {
        return GTA_PROVIDER_FWD_FUNCTION(
            p_ctx_obj->p_provider, gta_seal_data, (h_ctx, data, protected_data, p_errinfo));
    }
    *p_errinfo = GTA_ERROR_HANDLE_INVALID;
    return false;
}
    ...
    (gta_context_handle_t h_ctx, gtaio_istream_t * protected_data, gtaio_ostream_t * data, gta_errinfo_t * p_errinfo))
{
    ...
    if (NULL != p_ctx_obj) {
        return GTA_PROVIDER_FWD_FUNCTION(
            p_ctx_obj->p_provider, gta_unseal_data, (h_ctx, protected_data, data, p_errinfo));
    }
    *p_errinfo = GTA_ERROR_HANDLE_INVALID;
    return false;
}

GTA_DEFINE_FUNCTION(bool, gta_verify, (gta_context_handle_t h_ctx, gtaio_istream_t * claim, gta_errinfo_t * p_errinfo))
{
    const context_object_t * p_ctx_obj = NULL_PTR;
    ...
    p_ctx_obj = check_context_handle(h_ctx, p_errinfo);
    if (NULL != p_ctx_obj) {
        return GTA_PROVIDER_FWD_FUNCTION(p_ctx_obj->p_provider, gta_verify, (h_ctx, claim, p_errinfo));
    }
    *p_errinfo = GTA_ERROR_HANDLE_INVALID;
    return false;
}
    ...
    (gta_context_handle_t h_ctx, gtaio_istream_t * data, gtaio_ostream_t * seal, gta_errinfo_t * p_errinfo))
{
    ...
    if (p_ctx_obj) {
        return GTA_PROVIDER_FWD_FUNCTION(
            p_ctx_obj->p_provider, gta_authenticate_data_detached, (h_ctx, data, seal, p_errinfo));
    }
    *p_errinfo = GTA_ERROR_HANDLE_INVALID;
    return false;
}
...
static gta_handle_t alloc_handle(gta_handle_type_t type, void * params, void ** pp_obj, gta_errinfo_t * p_errinfo)
{
    ...
    if ((NULL_PTR != pp_obj) && (NULL_PTR != params)) {
        ...
        if (g_handle_map.get != g_handle_map.release) {
            ...
            case GTA_HANDLE_TYPE_INSTANCE:
                p_obj = create_instance_object((struct gta_instance_params_t *)params, p_errinfo);
                break;
            case GTA_HANDLE_TYPE_INSTANCE_PROVIDER:
                p_obj = create_instance_provider_object((instance_object_t *)params, p_errinfo);
                break;
            case GTA_HANDLE_TYPE_CONTEXT:
                p_obj = create_context_object((instance_object_t *)params, p_errinfo);
                break;
            case GTA_HANDLE_TYPE_ACCESS_POLICY:
                p_obj = create_access_policy_object((instance_object_t *)params, p_errinfo);
                break;
            case GTA_HANDLE_TYPE_ACCESS_POLICY_SIMPLE:
                p_obj = create_access_policy_object((instance_object_t *)params, p_errinfo);
                break;
            case GTA_HANDLE_TYPE_ACCESS_TOKEN_DESCRIPTOR:
                p_obj = create_access_token_descriptor_object((struct access_policy_object_t *)params, p_errinfo);
                break;
            case GTA_HANDLE_TYPE_FRAMEWORK_ENUM:
                p_obj = create_framework_enum_object((instance_object_t *)params, p_errinfo);
                break;
            default:
                break;
            }
...
static bool free_handle(gta_handle_t handle, gta_errinfo_t * p_errinfo)
{
    bool b_ret = false;

    /* basic sanity checks */
    if ((handle != GTA_HANDLE_INVALID) && ((size_t)handle <= GTA_HANDLE_MAP_SIZE)) {
        ...
        if (g_handle_map.map[(size_t)handle].p != NULL_PTR) {
            ...
            case GTA_HANDLE_TYPE_INSTANCE:
                b_ret = destroy_instance_object(g_handle_map.map[(size_t)handle].p, p_errinfo);
                break;
            case GTA_HANDLE_TYPE_INSTANCE_PROVIDER:
                b_ret = destroy_instance_provider_object(g_handle_map.map[(size_t)handle].p, p_errinfo);
                break;
            case GTA_HANDLE_TYPE_CONTEXT:
                b_ret = destroy_context_object(g_handle_map.map[(size_t)handle].p, p_errinfo);
                break;
            case GTA_HANDLE_TYPE_ACCESS_POLICY:
                b_ret = destroy_access_policy_object(g_handle_map.map[(size_t)handle].p, p_errinfo);
                break;
            case GTA_HANDLE_TYPE_ACCESS_POLICY_SIMPLE:
                b_ret = destroy_access_policy_object(g_handle_map.map[(size_t)handle].p, p_errinfo);
                break;
            case GTA_HANDLE_TYPE_ACCESS_TOKEN_DESCRIPTOR:
                b_ret = destroy_access_token_descriptor_object(g_handle_map.map[(size_t)handle].p, p_errinfo);
                break;
            case GTA_HANDLE_TYPE_FRAMEWORK_ENUM:
                b_ret = destroy_framework_enum_object(g_handle_map.map[(size_t)handle].p, p_errinfo);
                break;
            default:
                break;
            }
            ...
            if (b_ret) {
                gta_memset(
                    &(g_handle_map.map[(size_t)handle]), sizeof(handle_map_entry_t), 0, sizeof(handle_map_entry_t));
                g_handle_map.free[g_handle_map.release] = handle;

                g_handle_map.release = (g_handle_map.release % GTA_HANDLE_MAP_SIZE) + 1;
            } else {
                *p_errinfo = GTA_ERROR_INTERNAL_ERROR;
            }
        } else {
...
static void * check_handle(gta_handle_t handle, gta_handle_type_t type, gta_errinfo_t * p_errinfo)
{
    ...
    if ((handle != GTA_HANDLE_INVALID) && ((size_t)handle <= GTA_HANDLE_MAP_SIZE)) {
        ...
        if ((g_handle_map.map[(size_t)handle].type == type) && (g_handle_map.map[(size_t)handle].p != NULL_PTR)) {
    ...
    if (p_params != NULL) {
        ...
        if (NULL == p_inst_obj) {
            *p_errinfo = GTA_ERROR_MEMORY;
            ...
            memcpy(
                (/* const cast */ struct gta_instance_params_t *)(&(p_inst_obj->params)),
                p_params,
                sizeof(struct gta_instance_params_t));
        }
    }
...
static bool destroy_instance_object(instance_object_t * p_inst_obj, gta_errinfo_t * p_errinfo)
{
    bool b_ret = false;
    free_t p_free = NULL;
    gta_errinfo_t errinfo = 0;
...
check_instance_provider_handle(gta_instance_handle_t h_inst, gta_errinfo_t * p_errinfo)
{
    return (struct instance_provider_object_t *)check_handle(h_inst, GTA_HANDLE_TYPE_INSTANCE_PROVIDER, p_errinfo);
}

static object_t * create_instance_provider_object(instance_object_t * p_inst_obj, gta_errinfo_t * p_errinfo)
{
    struct instance_provider_object_t * p_instance_provider_obj = NULL;
    p_instance_provider_obj = p_inst_obj->params.os_functions.calloc(1, sizeof(struct instance_provider_object_t));
    if (NULL == p_instance_provider_obj) {
        *p_errinfo = GTA_ERROR_MEMORY;
    } else { /* initialize object */
...
static bool
destroy_instance_provider_object(struct instance_provider_object_t * p_instance_provider_obj, gta_errinfo_t * p_errinfo)
{
    bool b_ret = false;
    free_t p_free = NULL;
...
static instance_object_t * check_instance_handle(gta_instance_handle_t h_inst, gta_errinfo_t * p_errinfo)
{
...
static bool destroy_context_object(context_object_t * p_ctx_obj, gta_errinfo_t * p_errinfo)
{
    ...
    if (p_ctx_obj != NULL) {
        ...
        gta_memset(p_ctx_obj, sizeof(context_object_t), 0, sizeof(context_object_t));
#ifdef _CRTDBG_MAP_ALLOC
...
static struct framework_enum_object_t * check_framework_enum_handle(gta_enum_handle_t h_enum, gta_errinfo_t * p_errinfo)
{
    return (struct framework_enum_object_t *)check_handle(h_enum, GTA_HANDLE_TYPE_FRAMEWORK_ENUM, p_errinfo);
}

static object_t * create_framework_enum_object(instance_object_t * p_inst_obj, gta_errinfo_t * p_errinfo)
{
    struct framework_enum_object_t * p_framework_enum_obj = NULL;
    p_framework_enum_obj = p_inst_obj->params.os_functions.calloc(1, sizeof(struct framework_enum_object_t));
    if (NULL == p_framework_enum_obj) {
        *p_errinfo = GTA_ERROR_MEMORY;
    } else { /* initialize object */
...
#endif
        gta_memset(
            p_framework_enum_obj, sizeof(struct framework_enum_object_t), 0, sizeof(struct framework_enum_object_t));
#ifdef _CRTDBG_MAP_ALLOC
...
GTA_DEFINE_FUNCTION(
    bool,
    gta_access_policy_get_access_descriptor_type,
    (gta_access_policy_handle_t h_access_policy,
     gta_access_descriptor_handle_t h_access_token_descriptor,
     ...
     gta_errinfo_t * p_errinfo))
{
    ...
    p_token_descriptor_object = check_access_token_descriptor_handle(h_access_token_descriptor, p_errinfo);
     ...
     gta_errinfo_t * p_errinfo))
{
    ...
    if (NULL == p_token_descriptor_object)
        return false;
    if (NULL == pp_attr || NULL == p_attr_len) {
        *p_errinfo = GTA_ERROR_INVALID_PARAMETER;
        return false;
    }
...
static bool destroy_access_policy_object(struct access_policy_object_t * p_access_policy_obj, gta_errinfo_t * p_errinfo)
{
    bool b_ret = false;
    free_t p_free = NULL;
    ...
    if (p_access_policy_obj != NULL) {
        ...
        while (NULL != (p_access_token_descriptor_obj = list_remove_front(
                            (struct list_t **)(&(p_access_policy_obj->p_access_token_descriptor_list))))) {
            free_handle(p_access_token_descriptor_obj->h_self, p_errinfo);
        }

        gta_memset(
            p_access_policy_obj, sizeof(struct access_policy_object_t), 0, sizeof(struct access_policy_object_t));
#ifdef _CRTDBG_MAP_ALLOC
...
check_access_policy_handle(gta_context_handle_t h_access_policy, bool simple, gta_errinfo_t * p_errinfo)
{
    ...
    p_access_policy_obj =
        (struct access_policy_object_t *)check_handle(h_access_policy, GTA_HANDLE_TYPE_ACCESS_POLICY, &errinfo);

    /* check whether simple access policies are permitted within the callers context */
    if (NULL == p_access_policy_obj) {
        if (simple) {
            p_access_policy_obj = (struct access_policy_object_t *)check_handle(
                h_access_policy, GTA_HANDLE_TYPE_ACCESS_POLICY_SIMPLE, p_errinfo);
        } else {
            *p_errinfo = errinfo;
        }
    }
...
create_access_token_descriptor_object(struct access_policy_object_t * p_access_policy, gta_errinfo_t * p_errinfo)
{
    ...
    p_token_descriptor_object = p_access_policy->p_inst_obj->params.os_functions.calloc(
        1, sizeof(struct access_token_descriptor_object_list_item_t));
    if (NULL == p_token_descriptor_object) {
        *p_errinfo = GTA_ERROR_MEMORY;
    } else { /* initialize object */
...
#ifdef _CRTDBG_MAP_ALLOC
        p_free = p_token_descriptor_object->p_access_policy_obj->p_inst_obj->params.os_functions._free_dbg;
#else
        p_free = p_token_descriptor_object->p_access_policy_obj->p_inst_obj->params.os_functions
                     .free; /* save ptr value before erasing the object */
#endif
 ...
 */
GTA_DEFINE_FUNCTION(gta_mutex_t, no_mutex_create, ()) { return GTA_NO_MUTEX_PTR; }

GTA_DEFINE_FUNCTION(bool, no_mutex_destroy, (gta_mutex_t mutex))
{
...
GTA_DEFINE_FUNCTION(bool, no_mutex_lock, (gta_mutex_t mutex))
{
    if (GTA_NO_MUTEX_PTR == mutex) {
        return true;
    }
...
GTA_DEFINE_FUNCTION(bool, no_mutex_unlock, (gta_mutex_t mutex))
{
    if (GTA_NO_MUTEX_PTR == mutex) {
        return true;
    }
...
{
#if 1
    return (struct access_token_descriptor_object_list_item_t *)check_handle(
        h_access_token_descriptor, GTA_HANDLE_TYPE_ACCESS_TOKEN_DESCRIPTOR, p_errinfo);
#else
    access_token_descriptor_object_list_item_t * p_object = NULL;

    p_object =
        list_find(p_access_token_descriptor_list, &h_access_token_descriptor, access_token_descriptor_handle_cmp);
    if (p_object == NULL)
        *p_errinfo = GTA_ERROR_HANDLE_INVALID;
    ...
    gta_errinfo_t * p_errinfo)
{
    ...
    while (b_idloop) {
        ...
        if (gta_identifier_enumerate(h_inst, &h_idenum, &o_idtype, (gtaio_ostream_t *)&o_idvalue, &errinfo)) {
...
{
    bool b_ret = false;
    const struct secmem_block_t * p_secmem_block1 = (struct secmem_block_t *)(p_block1);
    const struct secmem_block_t * p_secmem_block2 = (struct secmem_block_t *)(p_block2);
...
{
    bool b_ret = false;
    const struct provider_list_item_t * p_provider = (struct provider_list_item_t *)(p_provider_list_item);
...
{
    bool b_ret = false;
    const struct profile_list_item_t * p_profile_list_itm = (struct profile_list_item_t *)(p_profile_list_item);

    if ((NULL_PTR != p_profile_list_itm) && (0 == strcmp(p_profile_list_itm->profile_name, p_profile_name))) {
